...
- Логотип в SVG, текст переведён в кривые: `assets/logo/logo-20sotok-light.svg` для тёмного фона, `logo-20sotok-dark.svg` для светлого, `logo-mark.svg` только знак. Знак подключён как favicon статического сайта.
